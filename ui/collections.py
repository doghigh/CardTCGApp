...
class CollectionTab(QWidget):
    """Collection browser with search, stats, and actions."""
    ...
    def refresh(self):
        ...
        self.stats_label.setText(
            f"📦 <b>{stats.get('total_cards', 0)}</b> unique cards  •  "
    ...
    def _delete_selected(self):
        ...
        reply = QMessageBox.question(self, "Confirm Delete",
            f"Delete {len(ids)} card(s)? This cannot be undone.")
    ...
    def _revalue_selected(self):
        ...
        if not ids:
            return
        QMessageBox.information(self, "Re-valuing", f"Re-fetching values for {len(ids)} card(s)...")
    ...
    def _export_csv(self):
        ...
        try:
            ...
            QMessageBox.information(self, "Export Successful", f"Collection exported to:\n{path}")
